        ...
        input_q.iter_mut().for_each(|(entity, text_data, cosmic_color, mut text_edit, mut cosmic_data)| {
            ...
            if let Some(layout) = buffer.line_layout(0) {
                ...
                if let Color::Srgba(value) = cosmic_rgba_to_bevy_srgba(cosmic_color.text_color) {
                    ...
                    .observe(TextInputBuilder::handle_buffer_texture_on_mouse_down)
                    .observe(TextInputBuilder::handle_buffer_texture_on_start_selection)
                    .observe(TextInputBuilder::handle_buffer_texture_on_selecting)
                    .id();
...
impl SetupWidget for TextInputBuilder {
    ...
    fn build(&mut self, r_data: &HashMap<String, RVal>, commands: &mut Commands) -> Entity {
        ...
        commands
            ...
            .observe(TextInputBuilder::on_mouse_up)
            .observe(TextInputBuilder::on_mouse_down)
            .observe(TextInputBuilder::on_mouse_over)
            .observe(TextInputBuilder::on_mouse_out);
