...
pub fn get_default_selector_style(border_width: UiRect) -> Style {
    Style {
...
pub fn default_selection_container_style() -> Style {
    Style {
...
pub fn default_selection_items_panel_style() -> Style {
    Style {
        width: Val::Percent(100.0),
        flex_direction: FlexDirection::Column,
        align_items: AlignItems::Center,
...
pub fn default_selection_label_style() -> Style {
    Style {
        width: Val::Percent(100.0),
        height: Val::Auto,
        justify_content: JustifyContent::Start,
...
pub fn set_selection_panel_pos(selector_style: &Style, panel_style: &mut Style, label_height: f32) {
    let mut pos = 0.0;
    let top_offset = 6.0;
